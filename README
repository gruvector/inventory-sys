...
* Dependencies
  ...
  php-scrypt - A PHP wrapper fo the scrypt hashing algorithm for hashing passwords  
  Scrypt is a key derivation function designed to be far more secure against hardware brute-force attacks .
  instructions for the installation php-scrypt can be found at https://github.com/DomBlack/php-scrypt 
