<div id="invoice"> 
    ...
    <!-- #invoice-header --> 
    <div id="invoice-info"> 
        <h2>Invoice# <strong><?php echo strtoupper(htmlspecialchars($data['Sale']['id'])); ?></strong></h2> 
    ...
    <table id="invoice-amount"> 
        ...
        <tfoot>
            ...
            <tr id="total_tr"> 
                <td colspan="2">&nbsp;</td> 
                <td colspan="2" class="total" id="total_currency"><span class="currency"> </span> Paid</td> 
                <td class="total">&#8373;<?php
                ...
                <td colspan="2">&nbsp;</td> 
                <td colspan="2" class="total" id="total_currency"><span class="currency"> </span>  Due</td> 
                <td class="total">&#8373;<?php
