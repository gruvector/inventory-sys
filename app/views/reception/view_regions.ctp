...
<div class='tableWrapper'>
    ...
    <table cellspacing='0' summary=''>
        ...
        <tbody>
    <?php $row_color=0;foreach($regions as $val){ ?>
            
            <tr id="<?php echo $val['Region']['id']  ?>" class='<?php echo ($row_color % 2==0) ? "even":"odd";  ?>'>
              <td class='toggleSelection'>
                  <input type='checkbox' value='1' />
                </td>
                <td>
             <?php echo $val['Region']['region_short_name']; ?>
                     
                </td>
                  <td>
              <?php echo $val['Region']['region_long_name']; ?>
               
                </td>
                                <td>
                    <ul class='rowActions'>
                        <li>
                            <a href='#' class='inlineIcon iconZoneAdd'>Edit Region</a>
                        </li>
