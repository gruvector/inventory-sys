...
<div class='tableWrapper'>
    <div class='tableHeader'>
        <ul class='tableActions'>
            <li>
                <a href='' class='inlineIcon iconWebsiteAdd'>Add New Constituency</a>
            </li>
    ...
    <table cellspacing='0' summary=''>
        ...
        <tbody>
    <?php $row_color=0;foreach($const as $val){ ?>
            
            <tr id="<?php echo $val['Constituency']['id'] ?>" class='<?php echo ($row_color % 2==0) ? "even":"odd";  ?>'>
              <td class='toggleSelection'>
                  <input type='checkbox' value='1' />
                </td>
                <td>
             <?php echo $val['Constituency']['const_short_name']; ?>
                     
                </td>
                  <td>
              <?php echo $val['Constituency']['const_long_name']; ?>
               
                </td>
                                <td>
                    <ul class='rowActions'>
                        <li>
                            <a href='#' class='inlineIcon iconZoneAdd'>Edit Constituency</a>
