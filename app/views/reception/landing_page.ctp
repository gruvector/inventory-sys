...
<div class='tableWrapper'>
    <div class='tableHeader' style="border:none;text-align:center;font-weight:bold;">
        <ul class='tableActions'>
            <li>
                PLEASE CLICK ON LINKS ON THE LEFT TO ACCESS PAGES .
                WILL REPLACE WITH NICE ICONS VERY SOON
            </li>
