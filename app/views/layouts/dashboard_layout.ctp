...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    ...
    <body class="hasInterface hasGradient hasSidebar">
        ...
        <input type="hidden" name="stock_notif_url" id="stock_notif_url" value="<?php echo $html->url(array('controller' => 'Customer', 'action' => 'min_stock_notif')); ?>" />
...
// ." ".$_SESSION['memberData']['User']['lname']; 
                        ...
                        <ul id="UL_120">
                            ...
                            <li id="LI_124" class="infoUser stn" 
                                href="<?php echo $html->url(array('controller' => 'User', 'action' => 'add_user')); ?>"
                                name="<?php echo $_SESSION['memberData']['User']['fname'] . " " . $_SESSION['memberData']['User']['lname'] ?>"
                                data-id="<?php echo $_SESSION['memberData']['User']['id'] ?>">
                                <a href="profile.html" id="A_125"><i id="I_126"></i>Profile</a>
                            </li>
                            <li id="LI_127" class="buttonLogout  footer">
                                <a href="<?php echo $html->url(array('controller' => 'Dashboard', 'action' => 'logoutUser')); ?>" id="A_128">
