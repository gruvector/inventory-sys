...
<form class="login_form" id="login_form" name="login_form" method="POST" action="<?php echo $this->Html->url(array('controller' => 'Dashboard', 'action' => 'index')); ?>">
    ...
    echo "install";
           ...
           <!--     <img class="break" src="<?php echo $this->Html->url('/mticket/img/login-welcome.gif') ?>" width="400" height="1" vspace="8" />-->
            </td>
        </tr>
        <tr>
            <td>&nbsp;</td>
